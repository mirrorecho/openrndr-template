...
//
//    companion object {
//        fun <S:LanguageNode>fromSelect(select: SelectInterface, context: ContextInterface = LocalContext): _Palette<S> {
//            val myPalette = _Palette<S>(context = context)
//            myPalette.extendBySelect(select)
//            return myPalette
//        }
//
//        fun <S:LanguageNode>fromKeys(vararg keys: String, context: ContextInterface = LocalContext): _Palette<S> {
//            val myPalette = _Palette<S>(context = context)
...
//        select.asSequence<T>().forEach { this.nodes[it.key]=it }
//    }
//
